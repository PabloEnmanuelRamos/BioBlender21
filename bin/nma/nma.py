...
def computeNormalMode(userfilenamein="", userfilenameout="NMA.pdb", usermode=0, userrmsd=0.8, usernbconf=5,
    ...
    mystruct_ca = mystruct.select(conf)
...
def main():
    try:
        opts, args = getopt.getopt(sys.argv[1:], "hi:o:m:r:n:g:c:",
                                   ["help", "input=", "output=", "mode=", "rmsd=", "nbconformations=", "gamma=",
                                    "cutoff=", "backbone", "calpha", "all"])
