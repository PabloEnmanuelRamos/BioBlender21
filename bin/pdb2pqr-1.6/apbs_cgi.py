...
def generateForm(file, initVars, pdb2pqrID, type):
    ...
    file.write(
        "<h3>Calculation on <a href=\"tmp/%s/%s\" target=\"_blank\">%s</a> with default values provided by PDB2PQR:</h3><br />\n" % (
    ...
    print(
        "/> Automatically-configured sequential focusing multigrid calculation <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#Automatic_sequential_focusing_multigrid_calculation_.28mg-auto.29\" target=\"_blank\"><font title=\"mg-auto\">(<span class=\"tooltip\">?</span>)</font></a>")
    ...
    print(
        """/> Automatically-configured parallel focusing multigrid calculation <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#Automatic_parallel_focusing_multigrid_calculation_.28mg-para.29\" target=\"_blank\"><font title=\"mg-para\">(<span class=\"tooltip\">?</span>)</font></a>""")
    ...
    print(
        """/> Manually-configured multigrid calculation <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#Manual_multigrid_calculation_.28mg-manual.29\" target=\"_blank\"><font title=\"mg-manual\">(<span class=\"tooltip\">?</span>)</font></a>""")
    ...
    print(
        """/> Manually-configured adaptive finite element calculation <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#Manual_adaptive_finite_element_calculation_.28fe-manual.29\" target=\"_blank\"><font title=\"fe-manual\">(<span class=\"tooltip\">?</span>)</font></a>""")
    ...
    print(
        """/> Surface and charge distribution property calculations (does not require solution of the PBE) <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#Manual_non-numerical_calculations_.28mg-dummy.29\" target=\"_blank\"><font title=\"mg-dummy\">(<span class=\"tooltip\">?</span>)</font></a>""")
    ...
    print("<tr>")
    print(
        "<td>Coarse mesh domain<br />lengths in a focusing<br />calculation <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#cglen\" target=\"_blank\"><font title=\"cglen\">(<span class=\"tooltip\">?</span>)</font></a></td>")
    print("<td><input type=\"text\" name=\"cglenx\" size=\"10\" maxlength=\"20\"")
    if 'coarseGridLength' in initVars:
    ...
    print("<tr>")
    print(
        "<td>Fine mesh domain<br />lengths in a focusing<br />calculation <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#fglen\" target=\"_blank\"><font title=\"fglen\">(<span class=\"tooltip\">?</span>)</font></a></td>")
    print("<td><input type=\"text\" name=\"fglenx\" size=\"10\" maxlength=\"20\"")
    if 'fineGridLength' in initVars:
    ...
    print("<tr>")
    print(
        "<td>Number of proces-<br />sors in a parallel<br />focusing calculation <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#pdime\" target=\"_blank\"><font title=\"pdime\">(<span class=\"tooltip\">?</span>)</font></a></td>")
    print("<td><input type=\"text\" name=\"pdimex\" size=\"10\" maxlength=\"20\"")
    if 'pdime' in initVars:
    ...
    print("<tr>")
    print(
        "<td>Mesh domain<br />lengths <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#glen\" target=\"_blank\"><font title=\"glen\">(<span class=\"tooltip\">?</span>)</font></a></td>")
    ...
    if 'processorMeshOverlap' in initVars:
    ...
    print(
        "<ul><li>Depth of the multilevel hierarchy used in the multigrid solver <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#nlev\" target=\"_blank\"><font title=\"nlev\">(<span class=\"tooltip\">?</span>)</font></a>:")
    ...
    if initVars['gridCenterMethod'] == "molecule" and ('gridCenterMoleculeID' in initVars):
    ...
    print(
        "<ul><li><input type=\"radio\" name=\"gcent\" value=\"coord\" onClick=\"showHide(\'gcentcoord\',\'gcentmol\');\"")
    ...
    if initVars['coarseGridCenterMethod'] == "molecule" and ('coarseGridCenterMoleculeID' in initVars):
    ...
    print(
        "<ul><li><input type=\"radio\" name=\"cgcent\" value=\"coord\" onClick=\"showHide(\'cgcentcoord\',\'cgcentmol\');\"")
    ...
    if 'coarseGridCenter' in initVars:
    ...
    if initVars['fineGridCenterMethod'] == "molecule" and ('fineGridCenterMoleculeID' in initVars):
    ...
    print(
        "<ul><li><input type=\"radio\" name=\"fgcent\" value=\"coord\" onClick=\"showHide(\'fgcentcoord\',\'fgcentmol\');\"")
    ...
    if initVars['solveType'] == "linearized":
        print("checked=\"checked\"")
    print(
        "/> Linearized <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#lpbe\" target=\"_blank\"><font title=\"lpbe\">(<span class=\"tooltip\">?</span>)</font></a></li>")

    print("<li><input type=\"radio\" name=\"solvetype\" value=\"npbe\"")
    if initVars['solveType'] == "nonlinearized":
        print("checked=\"checked\"")
    print(
        "/> Nonlinearized <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#npbe\" target=\"_blank\"><font title=\"npbe\">(<span class=\"tooltip\">?</span>)</font></a></li>")
    ...
    if initVars['solveType'] == "linearized regularized":
        print("checked=\"checked\"")
    print(
        "/> Linearized (regularized) <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#lrpbe\" target=\"_blank\"><font title=\"lrpbe\">(<span class=\"tooltip\">?</span>)</font></a></li>")

    print("<li><input type=\"radio\" name=\"solvetype\" value=\"nrpbe\"")
    if initVars['solveType'] == "nonlinearized regularized":
        print("checked=\"checked\"")
    print(
        "/> Nonlinearized (regularized) <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#nrpbe\" target=\"_blank\"><font title=\"nrpbe\">(<span class=\"tooltip\">?</span>)</font></a></li></div>")

    print("""</ul>
    </blockquote>""")

    print(
        "         <ul><li>Boundary condition definition <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#bcfl\" target=\"_blank\"><font title=\"bcfl\">(<span class=\"tooltip\">?</span>)</font></a>:</li></ul>")
    ...
    if initVars['boundaryConditions'] == "zero":
        print("checked=\"checked\"")
    print(
        "/> Zero <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#bcfl\" target=\"_blank\"><font title=\"zero\">(<span class=\"tooltip\">?</span>)</font></a></li>")

    print("<li><input type=\"radio\" name=\"bcfl\" value=\"sdh\"")
    if initVars['boundaryConditions'] == "sdh":
        print("checked=\"checked\"")
    print(
        "/> Single Debye-Huckel <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#bcfl\" target=\"_blank\"><font title=\"sdh\">(<span class=\"tooltip\">?</span>)</font></a></li>")

    print("<li><input type=\"radio\" name=\"bcfl\" value=\"mdh\"")
    if initVars['boundaryConditions'] == "mdh":
        print("checked=\"checked\"")
    print(
        "/> Multiple Debye-Huckel <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#bcfl\" target=\"_blank\"><font title=\"mdh\">(<span class=\"tooltip\">?</span>)</font></a></li>")

    print("<li><input type=\"radio\" name=\"bcfl\" value=\"focus\"")
    if initVars['boundaryConditions'] == "focus":
        print("checked=\"checked\"")
    print(
        "/> Focusing <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#bcfl\" target=\"_blank\"><font title=\"focus\">(<span class=\"tooltip\">?</span>)</font></a></li>")
    print("</ul></blockquote>")

    print("<ul>")
    print(
        """       <li>Mobile ion species present in system (optional) <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#ion\" target=\"_blank\"><font title=\"ion\">(<span class=\"tooltip\">?</span>)</font></a>:</li></ul>""")
    ...
    print(
        "         <ul><li>Biomolecular dielectric constant <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#pdie\" target=\"_blank\"><font title=\"pdie\">(<span class=\"tooltip\">?</span>)</font></a>:")

    print("<input type=\"text\" name=\"pdie\" size=\"10\" maxlength=\"20\"")
    if 'biomolecularDielectricConstant' in initVars:
    ...
    print(
        "         <ul><li>Dielectric constant of solvent <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#sdie\" target=\"_blank\"><font title=\"sdie\">(<span class=\"tooltip\">?</span>)</font></a>:")

    print("         <input type=\"text\" name=\"sdie\" size=\"10\" maxlength=\"20\"")
    if 'dielectricSolventConstant' in initVars:
    ...
    if ('biomolecularPointChargeMapMethod' in initVars) and initVars['biomolecularPointChargeMapMethod'] == "spl0":
        print("checked")
    print(
        "/> Traditional trilinear interpolation <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#chgm\" target=\"_blank\"><font title=\"spl0\">(<span class=\"tooltip\">?</span>)</font></a></li>")

    print("<li><input type=\"radio\" name=\"chgm\" value=\"spl2\"")
    if ('biomolecularPointChargeMapMethod' in initVars) and initVars['biomolecularPointChargeMapMethod'] == "spl2":
        print("checked=\"checked\"")
    print(
        "/> Cubic B-spline discretization <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#chgm\" target=\"_blank\"><font title=\"spl2\">(<span class=\"tooltip\">?</span>)</font></a></li>")

    print("<li><input type=\"radio\" name=\"chgm\" value=\"spl4\"")
    if ('biomolecularPointChargeMapMethod' in initVars) and initVars['biomolecularPointChargeMapMethod'] == "spl4":
        print("checked")
    print(
        "/> Quintic B-spline discretization <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#chgm\" target=\"_blank\"><font title=\"spl4\">(<span class=\"tooltip\">?</span>)</a></font></li>")
    print("</ul></blockquote>")

    print(
        "         <ul><li>Number of grid points per square-angstrom to use in surface constructions <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#sdens\" target=\"_blank\"><font title=\"sdens\">(<span class=\"tooltip\">?</span>)</font></a>:")

    print("<input type=\"text\" name=\"sdens\" size=\"10\" maxlength=\"20\"")
    if 'surfaceConstructionResolution' in initVars:
    ...
    if ('dielectricIonAccessibilityModel' in initVars) and initVars['dielectricIonAccessibilityModel'] == "mol":
        print("checked=\"checked\"")

    print(
        "/> Dielectric coefficient is defined based on a molecular surface definition; ion-accessibility coefficient is defined by an \"inflated\" van der Waals model <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#srfm\" target=\"_blank\"><font title=\"mol\">(<span class=\"tooltip\">?</span>)</font></a>.</li>")

    print("<li><input type=\"radio\" name=\"srfm\" value=\"smol\"")
    if ('dielectricIonAccessibilityModel' in initVars) and initVars['dielectricIonAccessibilityModel'] == "smol":
        print("checked=\"checked\"")
    ...
    if ('dielectricIonAccessibilityModel' in initVars) and initVars['dielectricIonAccessibilityModel'] == "spl2":
        print("checked=\"checked\"")

    print(
        "/> Dielectric and ion-accessibility coefficients are defined by a cubic-spline surface <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#srfm\" target=\"_blank\"><font title=\"spl2\">(<span class=\"tooltip\">?</span>)</font></a>.</li>")

    print("<li><input type=\"radio\" name=\"srfm\" value=\"spl4\"")
    if ('dielectricIonAccessibilityModel' in initVars) and initVars['dielectricIonAccessibilityModel'] == "spl4":
        print("checked=\"checked\"")

    print(
        "/> Dielectric and ion-accessibility coefficients are defined by a 7th order polynomial <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#srfm\" target=\"_blank\"><font title=\"spl4\">(<span class=\"tooltip\">?</span>)</font></a>.</li>")
    print("</ul></blockquote>")

    print(
        "         <ul><li>Radius of the solvent molecules <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#srad\" target=\"_blank\"><font title=\"srad\">(<span class=\"tooltip\">?</span>)</font></a>:")

    print("<input type=\"text\" name=\"srad\" size=\"10\" maxlength=\"20\"")
    if initVars['solventRadius'] is not None:
    ...
    if 'surfaceDefSupportSize' in initVars:
    ...
    print(
        """/> Don\'t calculate any energies <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#calcenergy\" target=\"_blank\"><font title=\"no\">(<span class=\"tooltip\">?</span>)</font></a>.</li>""")
    ...
    print(
        """/> Calculate and return total electrostatic energy for the entire molecule <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#calcenergy\" target=\"_blank\"><font title=\"total\">(<span class=\"tooltip\">?</span>)</font></a>.</li>""")
    ...
    print(
        """/> Don\'t calculate any forces <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#calcforce\" target=\"_blank\"><font title=\"no\">(<span class=\"tooltip\">?</span>)</font></a>.</li>""")
    ...
    print(
        """/> Calculate and return total electrostatic and apolar forces for the entire molecule <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#calcforce\" target=\"_blank\"><font title=\"total\">(<span class=\"tooltip\">?</span>)</font></a>.</li>""")
    ...
    print(
        """/> Write out the biomolecular charge distribution in units of e<sub>c</sub> (multigrid only) <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#write\" target=\"_blank\"><font title=\"charge\">(<span class=\"tooltip\">?</span>)</font></a>.</li>""")
    ...
    print(
        """/> Write out the electrostatic potential in units of k<sub>b</sub>T/e<sub>c</sub>  (multigrid and finite element) <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#write\" target=\"_blank\"><font title=\"pot\">(<span class=\"tooltip\">?</span>)</font></a>.</li>""")
    ...
    print(
        """/> Write out the solvent accessibility defined by the molecular surface definition <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#write\" target=\"_blank\"><font title=\"smol\">(<span class=\"tooltip\">?</span>)</font></a>.</li>""")
    ...
    print(
        """/> Write out the spline-based solvent accessibility <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#write\" target=\"_blank\"><font title=\"sspl\">(<span class=\"tooltip\">?</span>)</font></a>.</li>""")
    ...
    print(
        """/> Write out the van der Waals-based solvent accessibility <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#write\" target=\"blank\"><font title=\"vdw\">(<span class=\"tooltip\">?</span>)</font></a>.</li>""")
    ...
    print(
        """/> Write out the inflated van der Waals-based ion accessibility <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#write\" target=\"_blank\"><font title=\"ivdw\">(<span class=\"tooltip\">?</span>)</font></a>.</li>""")
    ...
    print(
        """/> Write out the Laplacian of the potential in units of k<sub>B</sub>T/e<sub>c</sub>/A<sup>2</sup> (multigrid only) <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#write\" target=\"_blank\"><font title=\"lap\">(<span class=\"tooltip\">?</span>)</font></a>.</li>""")
    ...
    print(
        """/> Write out the \"energy density\" in units of k<sub>B</sub>T/e<sub>c</sub>/A<sup>2</sup> (multigrid only) <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#write\" target=\"_blank\"><font title=\"edens\">(<span class=\"tooltip\">?</span>)</font></a>.</li>""")
    ...
    print(
        """/> Write out the mobile ion number density for <i>m</i> ion species in units of M (multigrid only) <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#write\" target=\"_blank\"><font title=\"ndens\">(<span class=\"tooltip\">?</span>)</font></a>.</li>""")
    ...
    print(
        """/> Write out the mobile charge density for <i>m</i> ion species in units of e<sub>c</sub> M (multigrid only) <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#write\" target=\"_blank\"><font title=\"qdens\">(<span class=\"tooltip\">?</span>)</font></a>.</li>""")
    ...
    print(
        """/> Write out the dielectric map shifted by <sup>1</sup>/<sub>2</sub> grid spacing in the x-direction <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#write\" target=\"_blank\"><font title=\"dielx\">(<span class=\"tooltip\">?</span>)</font></a>.</li>""")
    ...
    print(
        """/> Write out the dielectric map shifted by <sup>1</sup>/<sub>2</sub> grid spacing in the y-direction <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#write\" target=\"_blank\"><font title=\"diely\">(<span class=\"tooltip\">?</span>)</font></a>.</li>""")
    ...
    print(
        """/> Write out the dielectric map shifted by <sup>1</sup>/<sub>2</sub> grid spacing in the z-direction <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#write\" target=\"_blank\"><font title=\"dielz\">(<span class=\"tooltip\">?</span>)</font></a>.</li>""")
    ...
    print(
        """/> OpenDX (multigrid and finite element) <a href=\"http://apbs.wustl.edu/MediaWiki/index.php/ELEC_input_file_section#write\" target=\"_blank\"><font title=\"dx\">(<span class=\"tooltip\">?</span>)</font></a></li>""")
...
def unpickleVars(pdb2pqrID):
    ...
    pfile = open("%s%s%s/%s-input.p" % (INSTALLDIR, TMPDIR, pdb2pqrID, pdb2pqrID), 'rb')
...
def pqrFileCreator(apbsOptions):
    ...
    input.write('%s%s %s %s%s' % (
        apbsOptions['tab'], apbsOptions['readType'], apbsOptions['readFormat'], apbsOptions['pqrPath'],
    ...
    if ('mobileIonSpeciesCharge' in apbsOptions) and ('conc' in apbsOptions) and ('radius' in apbsOptions):
        input.write('%sion %d %g %g\n' % (
            apbsOptions['tab'], apbsOptions['mobileIonSpeciesCharge'], apbsOptions['mobileIonSpeciesConcentration'],
            apbsOptions['mobileIonSpeciesRadius']))
    ...
    if apbsOptions['writeSmol']:
        input.write(
            '%swrite smol %s %s-smol\n' % (apbsOptions['tab'], apbsOptions['writeFormat'], apbsOptions['writeStem']))

    if apbsOptions['writeSspl']:
        input.write(
            '%swrite sspl %s %s-sspl\n' % (apbsOptions['tab'], apbsOptions['writeFormat'], apbsOptions['writeStem']))
    ...
    if apbsOptions['writeEdens']:
        input.write(
            '%swrite edens %s %s-edens\n' % (apbsOptions['tab'], apbsOptions['writeFormat'], apbsOptions['writeStem']))

    if apbsOptions['writeNdens']:
        input.write(
            '%swrite ndens %s %s-ndens\n' % (apbsOptions['tab'], apbsOptions['writeFormat'], apbsOptions['writeStem']))

    if apbsOptions['writeQdens']:
        input.write(
            '%swrite qdens %s %s-qdens\n' % (apbsOptions['tab'], apbsOptions['writeFormat'], apbsOptions['writeStem']))

    if apbsOptions['writeDielx']:
        input.write(
            '%swrite dielx %s %s-dielx\n' % (apbsOptions['tab'], apbsOptions['writeFormat'], apbsOptions['writeStem']))

    if apbsOptions['writeDiely']:
        input.write(
            '%swrite diely %s %s-diely\n' % (apbsOptions['tab'], apbsOptions['writeFormat'], apbsOptions['writeStem']))

    if apbsOptions['writeDielz']:
        input.write(
            '%swrite dielz %s %s-dielz\n' % (apbsOptions['tab'], apbsOptions['writeFormat'], apbsOptions['writeStem']))

    if apbsOptions['writeKappa']:
        input.write(
            '%swrite kappa %s %s-kappa\n' % (apbsOptions['tab'], apbsOptions['writeFormat'], apbsOptions['writeStem']))
    ...
    for file in resp._outputFile:
        ...
        if fileName != "Standard Output" and fileName != "Standard Error":
            if fileName.rfind('-') != -1:
                ...
                fileName = jobid + fileName[fileName.rfind('.'):]
            url.urlretrieve(file._url, '%s%s%s/%s' % (INSTALLDIR, TMPDIR, jobid, fileName))  # HARDCODED
...
def redirector(logTime):
    ...
    string = ""
    string += '<html> <head>'
    string += '<meta http-equiv=\"refresh\" content=\"0;url=querystatus.cgi?jobid=%s&calctype=apbs\"/></head></html>' % str(
        logTime)
    return string
...
def mainInput():
    ...
    if "jobid" in form:  # means it's not the first run
        firstRun = False
    ...
    if "hiddencheck" in form:  # means this time apbs must be run
        firstRun = False
