...
class AppServicePortSoapBindingSOAP:
    ...
    def getOutputAsBase64ByName(self, request):
        ...
        response = self.binding.Send(None, None, request,
                                     soapaction="http://nbcr.sdsc.edu/opal/getOutputAsBase64ByName", **kw)
    ...
    def launchJobBlocking(self, request):
        ...
        if not isinstance(request, launchJobBlockingRequest) and \
            ...
            raise TypeError("%s incorrect request type" % request.__class__)
        kw = {}
        response = self.binding.Send(None, None, request, soapaction="http://nbcr.sdsc.edu/opal/launchJobBlocking",
                                     **kw)
