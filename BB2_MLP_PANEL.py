    ...
    if ExistMLP(namemlp) == False:
        ...
        if force:
            ...
            command = "%s %s -i %s -m %s -s %f -o %s -v" % (
                ...
                panel.quotedPath(homePath + "bin" + os.sep + "pyMLP-1.0" + os.sep + "pyMLP.py"),
                panel.quotedPath(homePath + "tmp" + os.sep + "tmp.pdb"), method, spacing,
                panel.quotedPath(homePath + "tmp" + os.sep + "tmp.dx"))
...
def mlpRender(tID):
    ...
    if opSystem == "linux":
        os.chdir(panel.quotedPath(homePath + "tmp" + os.sep))
    elif opSystem == "darwin":
        os.chdir(panel.quotedPath(homePath + "tmp" + os.sep))
    else:
    ...
    if blenderPath == "":
        ...
        command = "%s -b %s -f 1" % (panel.quotedPath(bP), panel.quotedPath(homePath + "tmp" + os.sep + "composite.blend"))
    else:
        command = "%s -b %s -f 1" % (panel.quotedPath(blenderPath), panel.quotedPath(homePath + "tmp" + os.sep + "composite.blend"))
